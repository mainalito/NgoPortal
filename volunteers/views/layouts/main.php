...
<body class="hold-transition sidebar-mini layout-fixed layout-footer-fixed layout-navbar-fixed">
    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <!--                             src="data:image/jpg;charset=utf8;base64,--><?php //echo base64_encode(Yii::$app->user->identity->profile); 
                                                                                                    ?><!--"-->
                        <!--                             alt="User Avatar">-->
        ...
        <aside class="main-sidebar sidebar-light-green elevation-4" style="background-color: gold;">
            <!-- Brand Logo -->
            ...
            <div class="sidebar">
                ...
                <!--                    <div class="info">-->
                <!--                        <a href="/" class="d-block"><b>--><?php //= Yii::$app->user->identity->organizationName 
                                                                                ?><!--</b></a>-->
                <!--                    </div>-->
                <!--                </div>-->
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item <?= ($currentPage == 'support') ? 'active' : ''; ?>">
                                    <a href="/support/" class="nav-link"><i class="fas fa-upload nav-icon"></i>
                                        <p>Support</p>
                                    </a>
                                </li>
                            </ul>
