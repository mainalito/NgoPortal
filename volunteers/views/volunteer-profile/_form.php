...
<div class="volunteer-profile-form">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <?= $form->field($model, 'lastNames')->textInput(['value' => $user->lastnames, 'readonly'=> true]) ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <?= $form->field($model, 'availabilityId')->widget(\kartik\select2\Select2::classname(), [
                'data' => \yii\helpers\ArrayHelper::map(\backend\models\VolunteerAvailability::find()->all(), 'countryId', 'countryName'),
                'language' => 'en',
                'options' => ['placeholder' => 'Select availability'],
                'pluginOptions' => [
                    'allowClear' => true
                ],
