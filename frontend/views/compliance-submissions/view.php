    ...
    <section class="content" id="basic-form-layouts">
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body">
                    <p class="float-right">
                        <?= $model->submitted != 1 ? Html::a('Update', ['update', 'submissionId' => $model->submissionId], ['class' => 'btn btn-info mr-1']) : '' ?>
                        <?= $model->submitted != 1 ? Html::a('Delete', ['delete', 'submissionId' => $model->submissionId], [
