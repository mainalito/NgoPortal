 ...
 * @property int|null $complied
 * @property int|null $notComplied
   ...
   public function save($runValidation = true, $attributeNames = null)
    ...
    public function rules()
    {
        return [
            ...
            [['year', 'deleted', 'createdBy', 'submitted', 'complied', 'notComplied'], 'integer'],
    ...
    public function getComplianceRate(){
        $rate = $this->complied/($this->complied + $this->notComplied) * 100;
