...
/**
 * This is the model class for table "membership_approval_status".
 *
 * @property int $id
 ...
 */
class MembershipApprovalStatus extends \yii\db\ActiveRecord
{
    /**
     * Added by Paul Mburu
    ...
    {
        return 'membership_approval_status';
    }
