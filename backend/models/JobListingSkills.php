...
/**
 * This is the model class for table "job_listing_skills".
 *
 * @property int $id
 ...
 */
class JobListingSkills extends \yii\db\ActiveRecord
{
    /**
     * Added by Paul Mburu
   ...
   public function save($runValidation = true, $attributeNames = null)
    ...
    {
        return [
            [['jobId', 'skillId', 'deleted', 'createdBy'], 'integer'],
            [['comments'], 'string'],
