...
$this->title = $model->user->organizationName;
    ...
    <section class="content" id="basic-form-layouts">
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body">
                    <p class="float-right">
                        <?= Html::a('Close', ['index'], ['class' => 'btn btn-warning mr-1']) ?>
                    </p>
...
<!--                                   aria-expanded="false"-->
<!--                                   onclick="loadpage('--><?php //= Yii::$app->urlManager->createUrl('compliance-submissions/data?submissionId=' . $model->submissionId . '&sectionId=' . $section->sectionId); ?><!--', 'tab3')">--><?php //= $section->sectionName; ?><!--</a>-->
<!--                            </li>-->
<!--                        --><?php //} ?>
<!--                        <li class="nav-item">-->
